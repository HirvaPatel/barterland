...
export default function User() {
  ...
  console.log(params);
  const api_url =
    process.env.REACT_APP_BACKEND_URL + `/api/users/${params.userId}`;
  useEffect(() => {
    fetch(api_url)
      .then((resp) => resp.json())
      .then((resp) => {
    ...
    <div className="user">
      ...
      <div className="userContainer">
        <div className="userShow">
          ...
          <div className="userShowTop">
            {user.picture !== undefined && (
              <img
                src={user.picture}
                alt="Profile Pic not uploded by User"
                className="userShowUserUserImage"
              ></img>
            )}
            {user.picture === undefined && (
              <img
        ...
        <div className="userUpdate">
          <span className="userUpdateTitle">Edit User Profile</span>
          <div>
